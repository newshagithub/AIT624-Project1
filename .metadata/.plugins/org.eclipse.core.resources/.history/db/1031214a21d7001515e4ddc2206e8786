...
// declaring and initializing subroutins for calculating //
	public static double CalBUI(double DRY, double WET, boolean ISNOW, double PRECIP, double WIND, double BUO, double IHERB){
...
// calculates Buildup Index
	...
	// calculates Fine Fuel Moisture	
		public static double CalFFM(double DRY, double WET, boolean ISNOW, double PRECIP, double WIND, double BUO, double IHERB){
			double DF,FFM,ADFM,GRASS,TIMBER,FLOAD, BUI;
			DF = 0;
			FFM = 99;
			ADFM = 99;
